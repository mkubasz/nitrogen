...
{
public sealed class BankPolskiejSpoldzielczosci TransactionBank : BankTransaction
{
public BankPolskiejSpoldzielczosci TransactionBank() : base("BankPolskiejSpoldzielczosci  Bank")
{
}
