...
{
public sealed class CreditAgricoleBankPolska TransactionBank : BankTransaction
{
public CreditAgricoleBankPolska TransactionBank() : base("CreditAgricoleBankPolska  Bank")
{
}
